...
export default function NotFoundPage() {
  return (
    <div className="relative bg-[#050917] min-h-screen">
      ...
      <div className="min-h-screen flex items-center justify-center relative overflow-hidden before:absolute before:top-0 before:start-1/2 before:bg-[url('https://preline.co/assets/svg/examples/polygon-bg-element.svg')] dark:before:bg-[url('https://preline.co/assets/svg/examples-dark/polygon-bg-element.svg')] before:bg-no-repeat before:bg-center before:bg-cover before:size-full before:-z-1 before:transform before:-translate-x-1/2 pt-16">
